...
public class DefaultChannelMonitorAggregator implements ChannelMonitorAggregator {
    ...
    void aggregateInfo(AggregatorStats aggregatorStats, Message message) {
        ...
        Map <String, AgentTopicStats > agentTopicStatsMap = Utils.fromJson(
                Utils.toJson(payload.getBody(), messageMapper), new TypeReference<Map<String, AgentTopicStats>>() {}, messageMapper
        );
